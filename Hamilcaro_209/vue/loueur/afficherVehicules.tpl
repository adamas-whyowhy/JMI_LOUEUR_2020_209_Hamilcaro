...
<html lang="fr">
	<head>
		...
		<title>Liste des véhicules | Location de voitures</title>
	...
	<body>
		...
		<main role="main" class="container">
			<div class="jumbotron" id="formulaire">
				...
				<p><a href="index.php?controle=loueur&action=ajouter">Ajouter un véhicule</a></p>
				<?php
					...
					foreach ($vehicules as $v) {	// pour chaque tableau de voitures
						...
						<div class="card mb-4 box-shadow">
							...
							Nombre de véhicules : ' . $v['Nb'] . '</br>
							Disponible à la location : ' . $v['Location'] . '</br>
