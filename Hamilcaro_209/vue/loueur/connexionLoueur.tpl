<?php 
	$email=htmlspecialchars($emailL);
	$num=htmlspecialchars($numL);
?>
	...
	<body>
		...
		<main role="main" class="container">
			<div class="jumbotron" id="formulaire">
				<div class="titre">
					<h3>Formulaire de connexion : Loueur</h3> 
				</div>
				<div class="contenu">
					<form action="index.php?controle=loueur&action=connexion" method="post">
