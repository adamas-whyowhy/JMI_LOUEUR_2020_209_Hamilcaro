	...
	<body>
		...
		<main role="main" class="container">
			...
			<div class="jumbotron" id="accueil">
				...
				<div class="contenu">
					<p><?php echo($nomClient)?>, bienvenue sur votre espace personnel. Vous êtes bien identifié en tant que client. Utilisez le menu pour vous déplacer sur notre site.</p>
